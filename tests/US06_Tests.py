...
class US06_Tests(unittest.TestCase):
    def test_divorce_before_death_no_error(self):
        ...
        family = Family("F1", "I1", None, None, date(2019, 6, 30))
    ...
    def test_divorce_after_death_error(self):
        ...
        family = Family("F1", "I1", None, None, date(2020, 3, 10))

        testReport.addToReport(individual)
        testReport.addToReport(family)

        testReport.divorce_before_death()
        self.assertEqual(testReport.errors[0].message, "Divorce of F1 (2020-03-10) occurs after the death of Jon Snow (2018-02-05)")

    def test_death_before_divorce_no_error(self):
        testReport: Report = Report()
        individual = Individual("I1", "Jon Snow", "M", date(1980, 5, 15), date(2020, 3, 10))
        family = Family("F1", "I1", None, None, date(2017, 12, 5))
